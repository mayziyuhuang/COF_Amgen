...
plt.errorbar(df_soda_wrubber_PAC['parylene_thickness'], df_soda_wrubber_PAC['mean'], yerr = df_soda_wrubber_PAC['std'], fmt='o', label = 'PA-C on white rubber vs soda lime wafer', color = '#1f77b4ff')
plt.errorbar(df_soda_wrubber_PAHT['parylene_thickness'], df_soda_wrubber_PAHT['mean'], yerr = df_soda_wrubber_PAHT['std'], fmt='s', label = 'PA-HT on white rubber vs soda lime wafer', color = '#1f77b4ff')

plt.errorbar(df_PAC_soda_wrubber_PAC['parylene_thickness'], df_PAC_soda_wrubber_PAC['mean'], yerr = df_PAC_soda_wrubber_PAC['std'], fmt='o', label = 'PA-C onwhite rubber vs PA-C on soda lime wafer', color = '#ff7f0eff')
plt.errorbar(df_PAC_soda_wrubber_PAHT['parylene_thickness'], df_PAC_soda_wrubber_PAHT['mean'], yerr = df_PAC_soda_wrubber_PAHT['std'], fmt='s', label = 'PA-HT on white rubber vs PA-C on soda lime wafer', color = '#ff7f0eff')

plt.errorbar(df_c_sr_PAC['parylene_thickness'], df_c_sr_PAC['mean'], yerr = df_c_sr_PAC['std'], fmt='o', label = 'PA-C on white rubber vs COP', color ='#2ca02cff' )
plt.errorbar(df_c_sr_PAHT['parylene_thickness'], df_c_sr_PAHT['mean'], yerr = df_c_sr_PAHT['std'], fmt='s', label = 'PA-HT on white rubber vs COP', color ='#2ca02cff' )
